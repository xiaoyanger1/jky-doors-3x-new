...
namespace Young.Core.Common
{
    public class MessageUtil
    {
        ...
        /// <param name="tiptitle">提示信息</param>
        public static DialogResult ShowTips(string message,string tiptitle="提示信息")
        {
            return MessageBox.Show(message, tiptitle, MessageBoxButtons.OK, MessageBoxIcon.Information);
        }
